<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 12:22:30
         compiled from "C:\xampp\htdocs\shop\themes\ap_office\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:251157ab62d69a1eb5-71272476%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e5e2f25ea9017240318aa93d85a247852ce9155' => 
    array (
      0 => 'C:\\xampp\\htdocs\\shop\\themes\\ap_office\\modules\\blockcart\\blockcart.tpl',
      1 => 1470848910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '251157ab62d69a1eb5-71272476',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ab62d6d24687_89917694',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab62d6d24687_89917694')) {function content_57ab62d6d24687_89917694($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\shop\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_function_counter')) include 'C:\\xampp\\htdocs\\shop\\tools\\smarty\\plugins\\function.counter.php';
?>
<!-- MODULE Block cart -->
<?php if (isset($_smarty_tpl->tpl_vars['blockcart_top']->value)&&$_smarty_tpl->tpl_vars['blockcart_top']->value) {?>
<div class="blockcart_top clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?> col-lg-2-4 col-md-4 col-sm-4 col-xs-12">
<?php }?>
...
" rel="nofollow">
					...
					<span class="ajax_cart_product_txt_s<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<2) {?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'item(s)','mod'=>'blockcart'),$_smarty_tpl);?>
						...
						<span class="ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'0 empty','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
					</div>
