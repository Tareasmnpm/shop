...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57ab687e334985_22423877',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab687e334985_22423877')) {function content_57ab687e334985_22423877($_smarty_tpl) {?>
            <div class="row" 
                    >
	...
	<div class="footer-block block" id="block_various_links_footer">
		...
		<ul class="toggle-footer list-group bullet">
							<li class="item">
					<a href="http://localhost/shop/bajamos-precios" title="Promociones especiales">
						Promociones especiales
					</a>
				</li>
									<li class="item">
				<a href="http://localhost/shop/nuevos-productos" title="Novedades">
					Novedades
				</a>
			</li>
										<li class="item">
					<a href="http://localhost/shop/mas-vendido" title="¡Lo más vendido!">
						¡Lo más vendido!
					</a>
				</li>
										<li class="item">
					<a href="http://localhost/shop/tiendas" title="Nuestras tiendas">
						Nuestras tiendas
					</a>
				</li>
									<li class="item">
				<a href="http://localhost/shop/contactanos" title="Contacte con nosotros">
					Contacte con nosotros
				</a>
			</li>
															<li class="item">
						<a href="http://localhost/shop/content/3-terminos-y-condiciones-de-uso" title="Términos y condiciones">
							Términos y condiciones
						</a>
					</li>
																<li class="item">
						<a href="http://localhost/shop/content/4-sobre-nosotros" title="Sobre nosotros">
							Sobre nosotros
						</a>
					</li>
													<li>
				<a href="http://localhost/shop/mapa-web" title="mapa del sitio">
					mapa del sitio
				</a>
			</li>
									<li>
...
<div class="widget-twitter block">
		...
		<div id="leo-twitter625941881705205762" class="leo-twitter">
			<a class="twitter-timeline" data-dnt="true"  data-theme="light" data-link-color="#000" width="250px" height="200px" data-chrome="noheader nofooter noborders transparent" data-border-color="#000" lang="es" data-tweet-limit="2" data-show-replies="0" href="https://twitter.com/leotheme"  data-widget-id="625941881705205762"  >Tweets by @leotheme</a>
  ...
  if ( $('[id*=leo-twitter625941881705205762]').length ) {
   $('#leo-twitter625941881705205762 iframe').each( function(){
    ...
    if ( ibody.find( '.timeline-TweetList li.timeline-TweetList-tweet' ).length ) {
		ibody.find( '.timeline-TweetList-tweet .timeline-Tweet-text' ).css( 'color', '#000' );
		ibody.find( '.TweetAuthor-screenName.Identity-screenName' ).css( 'color', '#000' );
		ibody.find( '.TweetAuthor-name.Identity-name.customisable-highlight' ).css( 'color', '#000' );
		if(show_scroll == 1){
