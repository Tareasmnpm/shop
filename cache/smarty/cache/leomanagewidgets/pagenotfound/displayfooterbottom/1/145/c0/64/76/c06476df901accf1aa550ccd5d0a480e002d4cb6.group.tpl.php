...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57ab7a1219c939_12204415',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab7a1219c939_12204415')) {function content_57ab7a1219c939_12204415($_smarty_tpl) {?>
            <div class="row" 
                    >
...
<div id="newsletter_block_left" class="block inline">
    <h4 class="title_block">Inscríbete alerta por correo electrónico sobre ofertas de productos y descuentos</h4>
    <div class="block_content">
		<form action="//localhost/shop/" method="post">
			<div class="form-group">
                ...
                <input type="submit" value="Regístrate" class="button_mini btn" name="submitNewsletter" />
...
<div class="widget-html block">
		...
		<div class="block_content">
		<p><a href="#"><img src="/shop/themes/ap_office/img/modules/leomanagewidgets/payment.png" alt="" /></a></p>
	</div>
</div>
                                                                                    </div>
                                                        </div>
